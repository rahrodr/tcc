        ...
        <div style="background-image: url(styles/imgstyle/elementoleft.png); background-size:contain" class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 mt-2 mb-5 ml-3">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-dark min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item">
                        <a href="menu.html" class="nav-link align-middle px-0">
                    ...
                    <li class="nav-item">
                        <a href="conversas.html" class="nav-link align-middle px-0">
                            <i class="bi bi-gem"></i>
                    ...
                    <li class="nav-item">
                        <a href="comunidades.html" class="nav-link align-middle px-0">
                    ...
                    <li class="nav-item">
                        <a href="config.html" class="nav-link align-middle px-0">
                ...
                <div class="dropdown pb-2">
                  <a href="perfilamg.html" class="d-flex align-items-center text-white text-decoration-none" aria-expanded="false">
    ...
    <div style="background-color: black" class="d-grid gap-3 flex-shrink-1">
        <div class="mt-2 p-2">
          <div class="mt-1 p-2">
            ...
            <a href="pedidos.html">
            <button type="button" class="btnamzds">
                Pedidos de amizade
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                2+
                <span class="visually-hidden">pedidos de amizade</span>
                </span>   
            </button>
            </a> 
        </div>
        <br>
        <section class="amigoschat">
        <div class="dropdown pb-2">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none" id="User1">
                <img src="imgs/iconamg.jpg" alt="foto de Rayssa" width="40" height="45" class="rounded-circle">
                <span class="contentleft">@rahrodr__</span> 
            </a>
             <p class="previsu">ta afim de jogar...</p> <br>
            <a href="#" class="d-flex align-items-center text-white text-decoration-none" id="User2" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="imgs/iconamg2.jpg" alt="foto de Carlos" width="40" height="45" class="rounded-circle">
                <span class="contentleft">@carlss33</span>
             </a>
              <p class="previsu">to carpindo um lot...</p> <br>
            <a href="#" class="d-flex align-items-center text-white text-decoration-none" id="User3" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="imgs/iconamg3.jpg" alt="foto de Jean" width="40" height="45" class="rounded-circle">
                <span class="contentleft">@j3an_n</span>
            </a>
             <p class="previsu">oii, tudo bem?</p>
        </div>
        </section>
        <section class="chat">
