...
<body>
  ...
  <div class="container-fluid">
    ...
    <div style="background-color: black" class="d-grid gap-3 flex-shrink-1">
        ...
        <br>
        <div style="display: flex;" class="dropdown pb-2">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="imgs/userunknow.jpg" alt="foto de user" width="40" height="40" class="rounded-circle">
                <span class="contentleft">@user5455</span>
            </a>
        ...
        <div style="display: flex;" class="dropdown pb-2">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="imgs/userunknow.jpg" alt="foto de user" width="40" height="40" class="rounded-circle">
                <span class="contentleft">@user6789</span>
            </a>
            <button id="aceitar">Aceitar</button>
            <button id="recusar">Recusar</button>
            <br>
