        ...
        <div class="mt-2 p-2">
          <div class="mt-1 p-2">
            ...
            <table>
                <tr>
                  <td>
                    <img  width="200" src='imgs/mk.jpg'></td>              
                  <td> 
                    <h1  class="txtcomunidade">Comunidade Mortal Kombat</h1>
                  </td> 
                </tr>

                <tr>
                    <td>
                      <img  width="200" src='imgs/mk2.jpg'></td>              
                    <td> 
                      <h1  class="txtcomunidade">Comunidade 2 Mortal Kombat</h1>
                    </td> 
                  </tr>

                  <td>
                    <img  width="200" src='imgs/mk3.jpg'></td>              
                  <td> 
                    <h1  class="txtcomunidade">Comunidade 3 Mortal Kombat</h1>
                  </td> 
                </tr>
